...
# =============================================================================
# 2. AUDIT EXECUTION FOR ALL 10 OPERATOR MODELS
# =============================================================================
...
def plot_first_layer_audit(df_res: pd.DataFrame, plot_dir: str = "Plots"):
    ...
    ax.set_title("First Layer Weight Audit: Mean Column $L_2$-Norm per Feature", fontsize=13, fontweight="bold")
    ...
    plt.tight_layout()
    path1 = os.path.join(plot_dir, "first_layer_weight_audit_mean_col.pdf")
    ...
    ax.set_title("First Layer Sensitivity Ratio: $\\|W_F^{(1)}\\|_2 / \\|W_U^{(1)}\\|_2$", fontsize=13, fontweight="bold")
    ...
    plt.tight_layout()
    path2 = os.path.join(plot_dir, "first_layer_weight_ratio.pdf")
...
if __name__ == "__main__":
    print("=" * 80)
    print("RUNNING FIRST-LAYER WEIGHT AUDIT ON ALL TRAINED MODELS")
    print("=" * 80)
    ...
    if df_audit.empty:
        ...
        print(df_audit[["model", "mean_col_f", "mean_col_u", "ratio_per_feature"]].to_string(index=False))
